...
fence verbatim and the page formats normally. It briefly did throw, which would
have let this table make a document unformattable that formatted before the
table existed.
